...
class DataStoreRepository @Inject constructor(
    ...
    suspend fun setBudgetBinderImage(budgetBinderImage: String) = dataStore.setBudgetBinderImage(budgetBinderImage)

    suspend fun getBudgetBinderImage() = dataStore.getBudgetBinderImage()

    suspend fun setSaveBinderImage(saveBinderImage: String) = dataStore.setSaveBinderImage(saveBinderImage)
